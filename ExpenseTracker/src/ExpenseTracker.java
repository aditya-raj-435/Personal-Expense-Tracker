...
public class ExpenseTracker {
    ...
    // Import the necessary JDBC library for your SQL server


    // Modify the initDB method
    private void initDB() {
        try {
            // Load the JDBC driver for your SQL server (e.g., MySQL)
            Class.forName("com.mysql.jdbc.Driver"); // Make sure to use the appropriate driver class

            // Establish a connection to your local SQL server

            String url = "jdbc:mysql://localhost:3306/expensetrackerjava";
            String username = "root";
            String password = "qwerty";
            Connection conn = DriverManager.getConnection(url, username, password);

            // Create tables if they do not exist (you might need to adapt the SQL syntax)
            ...
            // Close the statement (you can keep the connection open)
            statement.close();
        } catch (Exception e) {
            e.printStackTrace();
            System.exit(0);
